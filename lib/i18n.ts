...
export const translations = {
  he: {
    ...
    // Label overrides
    labels: 'שינוי שמות',
    labelOverrides: 'שינוי שמות פרשות וחגים',
    addLabel: 'הוסף שינוי שם',
    editLabel: 'ערוך שינוי שם',
    originalText: 'שם מקורי',
    replacementText: 'שם חדש',
    noLabels: 'אין שינויי שמות',
    labelHint: 'השם המקורי מוחלף בשם החדש בכל מקום (דפי חשבון, רכישות, לוח שנה). רכישות קיימות לא משתנות במסד הנתונים — רק התצוגה משתנה.',
    chooseFromList: 'בחר מרשימה',
    typeCustom: 'הקלד שם',
    item: 'פריט',
    weekHoliday: 'שבוע / חג',
    period: 'תקופה / שבוע',
  ...
  en: {
    ...
    labelOverrides: 'Rename Parasha & Holiday Labels',
    addLabel: 'Add Rename',
    editLabel: 'Edit Rename',
    originalText: 'Original Name',
    replacementText: 'New Name',
    noLabels: 'No renames defined',
    labelHint: 'The original name is replaced with the new name everywhere (statements, purchases, calendar). Existing purchase records stay intact in the database — only the display is changed.',
    chooseFromList: 'Pick from list',
